...
// Defaults are the FEV dev Firebase project's public web config (not secret;
// Firebase client API keys are safe to embed, same as admin's NEXT_PUBLIC_*
// vars). Override with --dart-define for other environments/projects.
