...
// tests for DocumentListItem
void main() {
  final instance = DocumentListItemBuilder();
  ...
  group(DocumentListItem, () {
    ...
    // String documentCode
    test('to test the property `documentCode`', () async {
      // TODO
    });
    ...
    // String fileFormat
    test('to test the property `fileFormat`', () async {
      // TODO
    });
