...
// tests for AssetDetail
void main() {
  final instance = AssetDetailBuilder();
  ...
  group(AssetDetail, () {
    ...
    // String assetTag
    test('to test the property `assetTag`', () async {
      // TODO
    });
    ...
    test('to test the property `categoryOther`', () async {
      // TODO
    });
    ...
    test('to test the property `installationDate`', () async {
      // TODO
    });
    ...
    // String model3dUrl
    test('to test the property `model3dUrl`', () async {
      // TODO
    });
    ...
    test('to test the property `parentAssetId`', () async {
      // TODO
    });
    ...
    // String qrCodeId
    test('to test the property `qrCodeId`', () async {
      // TODO
    });
