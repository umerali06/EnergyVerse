...
class PermissionsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [PermissionCatalog] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PermissionCatalog>> listPermissionCatalog({
    ...
    PermissionCatalog? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(PermissionCatalog),
    ...
    return Response<PermissionCatalog>(
      data: _responseData,
