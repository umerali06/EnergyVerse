...
class AuthApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CompanyRegistrationResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CompanyRegistrationResponse>> registerCompanyAdmin({
    ...
    try {
      ...
      _bodyData = _serializers.serialize(companyRegistrationRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
    ...
    CompanyRegistrationResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CompanyRegistrationResponse),
    ...
    return Response<CompanyRegistrationResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [VerificationEmailResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<VerificationEmailResponse>> sendVerificationEmail({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/auth/verification-email';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    VerificationEmailResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(VerificationEmailResponse),
    ...
    return Response<VerificationEmailResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
