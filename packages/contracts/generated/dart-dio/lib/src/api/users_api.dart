...
class UsersApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [UserDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserDetail>> getUser({
  ...
  /// Returns a [Future] containing a [Response] with a [UserDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserDetail>> inviteUser({
    ...
    final _path = r'/api/v1/users/invite';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _bodyData =
          _serializers.serialize(inviteUserRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UserListPage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserListPage>> listUsers({
    String? search,
    String? roleId,
    String? status,
    String? sort = 'name',
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(UserListPage),
            ) as UserListPage;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [UserDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserDetail>> setUserStatus({
    required String userId,
    required UpdateUserStatusRequest updateUserStatusRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/users/{user_id}/status'.replaceAll(
        '{' r'user_id' '}',
        encodeQueryParameter(_serializers, userId, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      const _type = FullType(UpdateUserStatusRequest);
      _bodyData =
          _serializers.serialize(updateUserStatusRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [UserDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserDetail>> updateUser({
    required String userId,
