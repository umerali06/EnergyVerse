...
class RolesApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [RoleDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RoleDetail>> createRole({
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(RoleDetail),
            ) as RoleDetail;
    } catch (error, stackTrace) {
      throw DioException(
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RoleDeleted] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RoleDeleted>> deleteRole({
    ...
    final _path = r'/api/v1/roles/{role_id}'.replaceAll(
        '{' r'role_id' '}',
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(RoleDeleted),
            ) as RoleDeleted;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [RoleDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RoleDetail>> getRole({
    required String roleId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [RoleDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RoleDetail>> updateRole({
    required String roleId,
