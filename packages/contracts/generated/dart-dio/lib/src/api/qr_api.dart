...
class QrApi {
  ...
  const QrApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [QrScanResult] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<QrScanResult>> resolveQrCode({
    ...
    final _path = r'/api/v1/qr/{code}/resolve'.replaceAll(
        '{' r'code' '}',
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(QrScanResult),
            ) as QrScanResult;
