...
class FacilitiesApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [FacilityDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FacilityDetail>> createFacility({
    required CreateFacilityRequest createFacilityRequest,
    ...
    try {
      const _type = FullType(CreateFacilityRequest);
      _bodyData =
          _serializers.serialize(createFacilityRequest, specifiedType: _type);
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(FacilityDetail),
            ) as FacilityDetail;
    } catch (error, stackTrace) {
      throw DioException(
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [FacilityDeleted] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FacilityDeleted>> deleteFacility({
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(FacilityDeleted),
            ) as FacilityDeleted;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
    ...
    return Response<FacilityDeleted>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [FacilityDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FacilityDetail>> getFacility({
    required String facilityId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [FacilityListPage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FacilityListPage>> listFacilities({
    String? search,
    String? status,
    String? sort = 'name',
    String? cursor,
    ...
    FacilityListPage? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(FacilityListPage),
            ) as FacilityListPage;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
    ...
    return Response<FacilityListPage>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [FacilityDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FacilityDetail>> updateFacility({
    required String facilityId,
    required UpdateFacilityRequest updateFacilityRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateFacilityRequest);
      _bodyData =
          _serializers.serialize(updateFacilityRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
