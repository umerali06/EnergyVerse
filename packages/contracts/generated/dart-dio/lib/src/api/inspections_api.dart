...
class InspectionsApi {
  ...
  Future<Response<InspectionDetail>> assignInspectionChecklistTemplate({
    required String inspectionId,
    required AssignChecklistTemplateRequest assignChecklistTemplateRequest,
    ...
    final _path = r'/api/v1/inspections/{inspection_id}/checklist-template'
        .replaceAll(
            '{' r'inspection_id' '}',
    ...
    try {
      const _type = FullType(AssignChecklistTemplateRequest);
      _bodyData = _serializers.serialize(assignChecklistTemplateRequest,
          specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [InspectionDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InspectionDetail>> attachInspectionMedia({
    required String inspectionId,
    required AttachInspectionMediaRequest attachInspectionMediaRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/inspections/{inspection_id}/media'.replaceAll(
        '{' r'inspection_id' '}',
  ...
  /// Returns a [Future] containing a [Response] with a [InspectionDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InspectionDetail>> cancelInspection({
    required String inspectionId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/inspections/{inspection_id}/cancel'.replaceAll(
        '{' r'inspection_id' '}',
        encodeQueryParameter(_serializers, inspectionId, const FullType(String))
            .toString());
    final _options = Options(
  ...
  Future<Response<InspectionDetail>> completeInspection({
    ...
    final _path = r'/api/v1/inspections/{inspection_id}/complete'.replaceAll(
        '{' r'inspection_id' '}',
        encodeQueryParameter(_serializers, inspectionId, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// Returns a [Future] containing a [Response] with a [InspectionDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InspectionDetail>> createInspection({
    required CreateInspectionRequest createInspectionRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/inspections';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(CreateInspectionRequest);
      _bodyData =
          _serializers.serialize(createInspectionRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [InspectionDeleted] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InspectionDeleted>> deleteInspection({
    required String inspectionId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/inspections/{inspection_id}'.replaceAll(
        '{' r'inspection_id' '}',
        encodeQueryParameter(_serializers, inspectionId, const FullType(String))
            .toString());
    final _options = Options(
    ...
    InspectionDeleted? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(InspectionDeleted),
            ) as InspectionDeleted;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  /// Returns a [Future] containing a [Response] with a [InspectionDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InspectionDetail>> detachInspectionMedia({
    required String inspectionId,
    ...
    final _path = r'/api/v1/inspections/{inspection_id}/media/{media_id}'
        .replaceAll(
            '{' r'inspection_id' '}',
            encodeQueryParameter(
                    _serializers, inspectionId, const FullType(String))
  ...
  /// Returns a [Future] containing a [Response] with a [InspectionDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InspectionDetail>> getInspection({
    required String inspectionId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [InspectionListPage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InspectionListPage>> listInspections({
    String? assetId,
    String? facilityId,
    String? status,
    String? inspectorId,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      r'facility_id': encodeQueryParameter(
          _serializers, facilityId, const FullType(String)),
      r'status':
          encodeQueryParameter(_serializers, status, const FullType(String)),
      r'inspector_id': encodeQueryParameter(
          _serializers, inspectorId, const FullType(String)),
      r'from_date': encodeQueryParameter(
    ...
    InspectionListPage? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(InspectionListPage),
            ) as InspectionListPage;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  /// Returns a [Future] containing a [Response] with a [InspectionDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InspectionDetail>> startInspection({
    required String inspectionId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/inspections/{inspection_id}/start'.replaceAll(
        '{' r'inspection_id' '}',
        encodeQueryParameter(_serializers, inspectionId, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// Returns a [Future] containing a [Response] with a [InspectionDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InspectionDetail>> updateInspection({
    required String inspectionId,
    required UpdateInspectionRequest updateInspectionRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [InspectionDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InspectionDetail>> updateInspectionMedia({
    required String inspectionId,
    required String mediaId,
    required UpdateInspectionMediaRequest updateInspectionMediaRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
